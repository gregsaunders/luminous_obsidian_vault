...
## Key Supporting Facts (If Asked for More Detail)

**Technology Validation:**
- TRL 8 (field validated, multi-season pilot at Imperial Kearl)
- 3-panel biosensor isolates toxic fraction (O2-NAFCs) from background carbon
- Relational Context Engine auto-correlates bio data with SCADA and weather

**Business Model:**
- 9-month pilots priced at cost recovery (zero profit margin)
- 50% ERA / Alberta Innovates grant matching available
- Converts to annual monitoring contract at commercial rates post-pilot

**Validated ROI ($260K/year):**
- $104K: Extended operating season (temp correlation proves treatment to 5°C)
- $78K: Flow optimization (spatial performance mapping)
- $36K: Toxicity proxy (eliminates expensive Microtox testing)
...
**Q: "Do you install hardware on our site?"**
A: Not for the pilot. We use an offsite lab model—you ship samples to our Calgary facility, we run the 3-panel analysis and push data to your dashboard. Zero site access friction, zero IT integration headaches during pilot phase.

**Q: "What happens to our data?"**
A: You own 100% of your site-specific data. We provide it in exportable format. Luminous retains our methodology (the biosensor tech and correlation algorithms), but you get all the insights and deliverables.
