...
* **Description:** Luminous provides an integrated "test-and-treat" platform for naphthenic acids (NAs) in oil sands processed water (OSPW).
* **Technology:**
    * **1. Biosensors (TRL 7-8):** Engineered bacteria that provide quantified NA results within 24 hours.
...
* **Founders:** Jeff Violo (COO), Greg Saunders (CTO), Shawn Lewenza (CSO).
* **Capitalization:** 51% Lewenza Labs (Shawn Lewenza), 49% Confluent Innovations Inc. (Violo, Saunders).
* **Financials:**
    * **Revenue:** Pre-revenue.
    * **Burn:** \$7.5K CAD / month.
    * **Runway:** ~9 months (as of Nov 2025).
    * **Raising:** \$1.5M CAD SAFE (Terms TBD).

## 3. CDL Program Status (Post-Session 1)

* **Stream:** CDL-Rockies Energy 2025/26.
* **Venture Leader:** [Denis Streltsov][p-denis].
* **Status:** Successfully passed Session 1. Proceeding to Session 2 (12-week sprint).

### Mentor Team

* **Lead Mentor:** [Jocelyn McMinn][m-jocelyn].
* **Formal Mentors (4+ hrs committed):**
    * [Terence Tham][m-terence].
    * [Dave Lee][m-dave].
* **Informal Mentors (Offered support):**
    * [Doug Beach][m-doug].
...
*This section will grow as we create new files.*
...
* **Strategy:**
    ...
    * `[Luminous - Fundraising Strategy.md][strat-fundraising]`
* **People:**
    * `[Luminous - Mentor Profiles.md][people-mentors]`
    * `[Luminous - Stakeholder Map.md][people-stakeholders]`
* **Archive:**
    * `[Archive - Luminous Initial Venture Overview.md][arc-overview]`
    * `[Archive - Luminous Initial Session 1 Update.md][arc-s1-update]`

[m-jocelyn]: Luminous - Mentor Profiles.md#Jocelyn-McMinn
[m-terence]: Luminous - Mentor Profiles.md#Terence-Tham
...
[people-stakeholders]: Luminous - Stakeholder Map.md

[strat-obj2]:        Luminous - Session 2 Objectives.md
[strat-mba]:         Luminous - MBA Project Brief.md
[strat-fundraising]: Luminous - Fundraising Strategy.md
