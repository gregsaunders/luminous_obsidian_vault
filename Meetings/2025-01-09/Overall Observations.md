...
### 3.5 Seek Light Legal Review
- Consider a quick consult with an attorney familiar with **university-owned IP transfers** to ensure our plan for acquiring the patent from AU is realistic
...
Given our discussions, and the desire to keep things **simple** while still protecting Shawn's invention, we appear to have **enough clarity** to:
...
- In **Luminous**, we all share an equal stake, with clear roles for Greg (operations/tech) and Jeff (sales/marketing)
