...
| **Customer Data** ([EPIC-03](SQH-EPIC-03-Unified-Data-Access-Layer.md)) | SQLAlchemy | Per-tenant `sqh_tenant_{slug}` | High-volume Platform Group models (e.g., lab results) | SQL WHERE clauses via `AccessContext` |
...
- Platform Group models can choose their backend: TerminusDB (graph) or PostgreSQL (relational) - see [EPIC-03](SQH-EPIC-03-Unified-Data-Access-Layer.md)
...
| PostgreSQL (SQLAlchemy) | Customer data ([EPIC-03](SQH-EPIC-03-Unified-Data-Access-Layer.md)) | ✓ Per-tenant DB + SQL WHERE |
...
#### Feature 4.1: Record Ownership Model
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.2: Ownership Policy Configuration
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.3: Unified Access Control Service
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.4: ABAC Condition Model
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.5: CDC Field Indexing
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.7: Qdrant Team + Attribute Filtering
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.8: Meilisearch Team Filtering
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.9: TerminusDB Enforcement
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.10: SearchService Integration
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.11: Agent Tool Enforcement
**Status:** 🔴 Not Started
**Priority:** High
...
#### Feature 4.14: Field-Level Security
**Status:** 🔴 Not Started
**Priority:** Low
...
#### Feature 4.15: Sharing & Explicit Grants
**Status:** 🔴 Not Started
**Priority:** Low
...
|-------|----------|-------|-----------|
| **Phase 1** | 4.1, 4.2, 4.3 | Ownership | Ownership fields + policies + unified service |
| **Phase 2** | 4.4, 4.5, 4.6 | ABAC | Attribute conditions for CDC data filtering |
| **Phase 3** | 4.7, 4.8, 4.9 | All | Wire storage layers (Qdrant, Meilisearch, TerminusDB) |
| **Phase 4** | 4.10, 4.11, 4.12 | All | Enforce at all entry points (API, Agents) |
| **Phase 5** | 4.13, 4.14, 4.15 | — | Advanced features (audit, field security, sharing) |

**Note:** RBAC is already implemented via Platform Group permissions. This EPIC adds Ownership and ABAC layers on top.

**Note:** For multi-backend access control (TerminusDB + PostgreSQL), see [EPIC-03 Feature 3.8](SQH-EPIC-03-Unified-Data-Access-Layer.md#feature-38-access-control-integration).
