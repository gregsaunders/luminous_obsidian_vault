# EPIC-12: Unified Data Access Layer
...
### Feature 12.1: Storage Configuration
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 12.2: Storage Backend Protocol
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 12.3: TerminusDB Backend
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 12.4: PostgreSQL Backend
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 12.5: Service Refactoring
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 12.6: PostgreSQL Query Service
**Status:** 🔴 Not Started
**Priority:** Medium
...
### Feature 12.7: TerminusDB Query Service
**Status:** 🔴 Not Started
**Priority:** Medium
...
### Feature 12.8: Access Control Integration
**Status:** 🔴 Not Started
**Priority:** High
...
|-------|----------|-----------|
| **Phase 1** | 12.1, 12.2 | Foundation: StorageConfig + Protocol |
| **Phase 2** | 12.3 | Extract existing TerminusDB logic |
| **Phase 3** | 12.4 | Add PostgreSQL backend |
| **Phase 4** | 12.5 | Refactor service to route by backend |
| **Phase 5** | 12.6, 12.7 | Backend-specific query services |
| **Phase 6** | 12.8 | Access control integration (with EPIC-11) |
...
**Related To:**
- [EPIC-11](SQH-EPIC-11-Record-Access-Control.md) - Access control integration (Feature 12.8)
