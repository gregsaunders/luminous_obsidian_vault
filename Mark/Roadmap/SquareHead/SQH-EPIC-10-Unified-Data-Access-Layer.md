# EPIC-10: Unified Data Access Layer
...
### Feature 10.1: Storage Configuration
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 10.2: Storage Backend Protocol
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 10.3: TerminusDB Backend
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 10.4: PostgreSQL Backend
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 10.5: Service Refactoring
**Status:** 🔴 Not Started
**Priority:** High
...
### Feature 10.6: PostgreSQL Query Service
**Status:** 🔴 Not Started
**Priority:** Medium
...
### Feature 10.7: TerminusDB Query Service
**Status:** 🔴 Not Started
**Priority:** Medium
...
### Feature 10.8: Access Control Integration
**Status:** 🔴 Not Started
**Priority:** High
**Depends On:** [EPIC-11](SQH-EPIC-11-Record-Access-Control.md)
...
|-------|----------|-----------|
| **Phase 1** | 10.1, 10.2 | Foundation: StorageConfig + Protocol |
| **Phase 2** | 10.3 | Extract existing TerminusDB logic |
| **Phase 3** | 10.4 | Add PostgreSQL backend |
| **Phase 4** | 10.5 | Refactor service to route by backend |
| **Phase 5** | 10.6, 10.7 | Backend-specific query services |
| **Phase 6** | 10.8 | Access control integration (with EPIC-11) |
...
**Related To:**
- [EPIC-11](SQH-EPIC-11-Record-Access-Control.md) - Access control integration (Feature 10.8)
