...
- **Advantages:**  
  ...
  3. **Flexibility for Investment/Acquisition:** It’s easier to spin off or sell one entity if, for example, a buyer only wants the IP or only the operational side.  
...
- **Disadvantages:**  
  ...
  3. **Potential Tax Considerations:** Income and expenses must be allocated properly between two entities, which can complicate filings.
...
- **Advantages:**  
  ...
  3. **Straightforward Profit Sharing & Decision-Making:** Everything is under one umbrella, so no inter-company licensing is needed.
...
2. **Shawn Maintains Majority Vote**  
   - **Mechanism:** Shawn could own **all or majority** of voting shares, while Greg and Jeff hold non-voting shares (or fewer voting shares).  
...
3. **Board-Control Mechanism**  
   - **Mechanism:** Equal share ownership, but the **Board composition** ensures Shawn can’t be outvoted on critical IP or strategic matters.  
...
3. **Field- or Territory-Specific License**  
   - E.g., Luminous gets exclusive rights for oil & gas applications, while Lewenza Labs can license to other sectors.  
...
**Why It Matters:**  
- A partnership can derail quickly if there’s no agreed-upon process for resolving disagreements about big decisions.
...
1. **Buyout at Predefined Terms**  
   - E.g., if a partner is inactive for X months, the company can repurchase their shares at a set formula.  
...
1. **Investment Rounds**  
   - Two-company structure might attract investors specifically for the IP or for the operations side.  
   - One-company structure is simpler for typical venture investments.  
   - **Pros/Cons:** More complexity vs. simpler term sheets.

2. **Strategic Partner/Acquisition**  
   - **Drag-Along and Tag-Along:** Ensure minority shareholders can’t block a major sale (drag-along), and minority shareholders can join a major sale on the same terms (tag-along).  
...
3. **Revenue Targets & Milestones**  
   ...
   - The structure should help them manage client relationships, expansions, and potential pivots.
...
**Why It Matters:**  
- Legal fees can add up quickly; budgeting for them is crucial. Also, any structure must comply with tax laws, possibly leveraging SR&ED credits for R&D.
...
1. **Immediate vs. Phased Approach:**  
   ...
   - Others suggest **starting with one** (perhaps Luminous) and **spinning off Lewenza Labs** later if the IP demands separate handling.

2. **Balancing IP Control with Simplicity:**  
   - Shawn’s strong interest in protecting his patent suggests leaning toward the **two-company** model with a **licensing agreement**.  
   - However, the team must weigh the **extra cost and complexity** against the benefits of an **easier-to-manage single-company** solution.
