...
def create_2_instructions(wb):
    ...
    ws.cell(row=row, column=1, value="6. Treatment Kinetics (Kearl 2022 Field Data)").font = FONT_HEADER
    row += 1
    ...
    # Change Log
    ws.cell(row=row, column=1, value="7. Change Log").font = FONT_HEADER
    row += 1
...
def create_3_assumptions(wb):
    ...
    site_config = [
        ...
        ('ValuePerM3', 5.00, '$/m3', 'Conservative operational value'),
    ]
